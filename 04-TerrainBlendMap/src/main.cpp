...
Terrain terrain(-1, -1, 200, 50, "../Textures/heightmap2.png");
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	Texture textureCesped("../Textures/arenadefault.jpg");
	...
	Texture textureR("../Textures/arenaoscura.jpg");
	...
	Texture textureG("../Textures/arenaondulada.jpg");
	...
	Texture textureB("../Textures/arenacamino.jpg");
